...
function PromptField({ label, hint, value, placeholder, disabled, dirty, onChange }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dlr-cell" + (dirty ? " dirty" : ""), children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dlr-cellHead", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dlr-cellLabel", children: label }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "textarea",
      {
...
function CodeChips({ selected, disabled, onToggle, onClear, onAdd }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dlr-chipsWrap", children: [
    (onAdd || custom.length > 0) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dlr-chipGroup", children: [
      ...
      onAdd && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dlr-addRow", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
          {
            className: "dlr-input",
...
var strOr = (v, d) => typeof v === "string" ? v : d;
...
function RetrySettingsRow({ useScope, scope }) {
  ...
  const [addMsg, setAddMsg] = (0, import_react.useState)(null);
  ...
  const addCode = (raw) => {
    ...
    if (!CODE_RE.test(code)) {
      setAddMsg({ kind: "bad", code });
      return;
    }
    const cur = codesOf(draft);
    if (cur.includes(code)) {
      setAddMsg({ kind: "dup", code });
      return;
    }
    setAddMsg(null);
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dlr-body", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dlr-section" + (draft.enabled ? "" : " dlr-disabled"), children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dlr-chipOuter", children: [
          ...
          addMsg && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dlr-chipHint" + (addMsg.kind === "bad" ? " dlr-addWarn" : ""), children: addMsg.kind === "dup" ? L.codesAddDup(addMsg.code) : L.codesAddBad(addMsg.code) }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dlr-section", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dlr-section" + (draft.autoContinue ? "" : " dlr-disabled"), children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dlr-note", children: draft.continuationPrompt.trim() === "" ? L.fieldPromptDefault : L.fieldPromptCustom }),
