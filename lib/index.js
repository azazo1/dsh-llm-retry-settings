...
var CONTINUATION_MAX_TOKENS = "\u4E0A\u4E00\u6761\u56DE\u590D\u56E0\u8FBE\u5230\u8F93\u51FA token \u4E0A\u9650\u88AB\u622A\u65AD. \u8BF7\u4ECE\u4E2D\u65AD\u5904\u76F4\u63A5\u7EE7\u7EED\u8F93\u51FA, \u4E0D\u8981\u91CD\u590D\u5DF2\u7ECF\u8F93\u51FA\u7684\u5185\u5BB9, \u4E5F\u4E0D\u8981\u91CD\u65B0\u5F00\u5934.";
var CONTINUATION_INTERRUPTED = "\u4E0A\u4E00\u8F6E\u5728\u5D29\u6E83\u540E\u88AB\u6807\u8BB0\u4E3A\u4E2D\u65AD. \u8BF7\u4ECE\u4E2D\u65AD\u5904\u7EE7\u7EED\u5B8C\u6210\u4EFB\u52A1, \u4E0D\u8981\u91CD\u590D\u5DF2\u7ECF\u5B8C\u6210\u7684\u6B65\u9AA4.";
function continuationForError(code, message) {
...
var TRANSIENT_TURN_ERROR_CODES = /* @__PURE__ */ new Set([
  "PI_AI_ERROR",
  "MALFORMED_RESPONSE",
  "TRANSPORT",
  "TIMEOUT",
...
var JSON_FAIL_RE = /unexpected end of json|json\.parse|malformed sse|not valid json|unexpected token/i;
function isTransientTurnError(code, message) {
...
function apply(ctx, config) {
  ...
  const handleTurnEnd = (session, turn, kind, via, agentHint, failure) => {
    const cfg = current();
