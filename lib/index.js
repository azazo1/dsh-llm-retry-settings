...
var Config = Schema.object({
  ...
  continuationPrompt: Schema.string().default(DEFAULTS.continuationPrompt),
  continueOnError: Schema.boolean().default(DEFAULTS.continueOnError),
  ...
  logPath: Schema.string().default(DEFAULTS.logPath)
});
